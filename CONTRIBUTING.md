...
Listed are a just a few small guidelines you need to follow.

## Reporting issues ##

Bugs, feature requests, and development-related questions should be directed to
our [GitHub issue tracker](https://github.com/google/gosplit/issues).  If
...
are more sensitive, emailed to <YouCanGetSelfish@google.com>.
...
## Submitting a patch ##
  ...
  1. Please run:
     * `go generate github.com/selfish/gosplit/...`
     * `go test github.com/selfish/gosplit/...`
